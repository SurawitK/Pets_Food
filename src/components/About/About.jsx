function SmallAbout() {
  return (
    <section className='bg-slate-100 my-24 container mx-auto overflow-hidden'>
      <div className='grid overflow-hidden'>
        <div className='overflow-hidden'>
          <img
            className='hover:scale-[105%] transition-all aspect-square object-[50%_30%] w-full'
        ...
        {/* <div className='grid content-center relative col-start-2'>
